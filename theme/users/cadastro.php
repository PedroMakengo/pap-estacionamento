        ...
        <div class="main-content">
          ...
          >
            <?php
              ...
              $meuCarroSelected = new Model();
              $buscandoMeuCarro = $meuCarroSelected->EXE_QUERY("SELECT * FROM tb_carro_cliente WHERE id_cliente=:id", $parametros);
              if($buscandoMeuCarro):?>
                <!-- Verificando se o cliente possui um carro  -->
              ...
              ?>
                <div class="container-fluid">
                  <div class="row">
                    <div  class="col-lg-12 col-xl-12 col-sm-12 mt-1" data-aos="fade-left" data-aos-duration="2300">
                      <div class="p-4 bg-warning">
                        <p>Ainda não possuís um carro, por favor <a href="registrar-carro.php?id=carro">registre o teu carro</a>.</p>
                      </div>
                    </div>
                  </div>
                </div>
